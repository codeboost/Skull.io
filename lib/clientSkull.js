  ...
  Model = (function() {
    ...
    function Model(options) {
      ...
      if (url && typeof url === 'string') {
        ...
        this.socket.on('broadcast', __bind(function(data) {
          if (data.__sid !== this.socket.socket.sessionid) {
            return this.trigger('server-broadcast', data);
          }
        }, this));
        ...
        this.bind('broadcast', __bind(function(data, callback) {
          log('Model broadcast ', data);
          return this.socket.emit('broadcast', data, callback);
        }, this));
      }
  ...
  Collection = (function() {
    ...
    function Collection(models, options) {
      ...
      this.socket.on('create', __bind(function(data) {
        var id, model;
        log('collection.add');
        id = data.__id || data[Backbone.Model.prototype.idAttribute];
        if (id) {
