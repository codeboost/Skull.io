...
(function() {
  var CollectionHelper, ModelHelper, Skull, SkullClient, serverLockModel, serverUnlockModel, _ref, _ref1,
  ...
  Backbone.sync = function(method, model, cbo) {
    var sync, _ref, _ref1, _ref2;
    sync = (_ref = (_ref1 = model.sync) != null ? _ref1 : (_ref2 = model.collection) != null ? _ref2.sync : void 0) != null ? _ref : Skull.BackboneSync;
  ...
  Skull.Model = (function(_super) {
    ...
    Model.prototype.name = function() {
      ...
      return (_ref1 = (_ref2 = this.collection) != null ? _ref2.url : void 0) != null ? _ref1 : (_ref3 = typeof this.url === "function" ? this.url() : void 0) != null ? _ref3 : this.url;
    };
    ...
    Model.prototype.sid = function() {
      var _ref1, _ref2;
      return (_ref1 = (_ref2 = this._skull) != null ? _ref2.sid : void 0) != null ? _ref1 : this.collection.sid();
    };

    Model.prototype.addEmbedded = function(model, name) {
      var _ref1;
      return ((_ref1 = this._skull) != null ? _ref1 : this.collection._skull).addModel(model, name);
    };

    Model.prototype.skullEmit = function() {
      var emitter, _ref1, _ref2, _ref3;
      emitter = (_ref1 = (_ref2 = this._skull) != null ? _ref2.socket : void 0) != null ? _ref1 : (_ref3 = this.collection._skull) != null ? _ref3.socket : void 0;
